                        ...
                        for (Voiture v : listvoiture) {
                            ...
                            out.println("  <div class=\"col-lg-4 col-md-6 mb-4\">\n" +
                                    ...
                                    "                                <h3><a href=\"#\">"+v.getMarque().toUpperCase()+"</a></h3>\n"+
                                                                    "  <div class=\"rating\">");
                            out.println(" <form action=\"modif\" method=\"GET\"><input name=\"mque\" type=\"hidden\" value=\""+v.getMarque()+"\">");
                                                ...
                                                out.println("  </div>\n" +
                                                        ...
                                                        "</form>");
                                                out.println(" <form action=\"del\" method=\"GET\"><input name=\"mque\" type=\"hidden\" value=\""+v.getMarque()+"\">"+
                                                        "<input type=\"submit\" class=\"btn btn-primary\" style=\"margin-left:9em\" value=\"Supprimer\">"+
                                                        "</form>"+
                                                                "                     </div>"+
                                                        "                        </div>\n" +
